...
public class Minigames {
    ...
    public static int trivial_history() {
        ...
        System.out.println("Segunda pregunta: ¿Cuál fue el evento que marcó el final de la Reconquista y la unificación de España en 1492?");
        System.out.println("-------------------------------------------------------------------------------------------");
        ...
        System.out.println("Tercera pregunta: ¿Qué conflicto bélico enfrentó a España contra Estados Unidos en 1898 y resultó en la pérdida de las últimas colonias españolas en América y Asia?");
        System.out.println("-------------------------------------------------------------------------------------------");
    ...
    public static int trivial_arithmetic() {
        ...
        System.out.println("Segunda pregunta: Si un libro cuesta 15 euros y quiero comprar 4 libros, ¿cuánto dinero necesitaré en total?");
        System.out.println("-------------------------------------------------------------------------------------------");
        ...
        System.out.println("Tercera pregunta: Calcula el área de un triángulo cuya base mide 8 cm y su altura mide 6 cm");
        System.out.println("-------------------------------------------------------------------------------------------");
    ...
    public static int trivial_sports() {
        ...
        System.out.println("Segunda pregunta: ¿Quién es el tenista con más títulos de Grand Slam en la historia del tenis masculino, con un total de 20 títulos hasta 2022?");
        System.out.println("-------------------------------------------------------------------------------------------");
